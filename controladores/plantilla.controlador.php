...
define('CRYPT_SALT', '$2a$07$plmnkoijbhuygvcftrdxsewa$');
define('EMAIL_FROM', 'info@sistemadeventas.com.ar'); */
...
class ControladorPlantilla
{
    ...
    {
        /* return "https://www.controlstock.com.ar/"; */
        /* return "https://www.controlstock.com.ar/"; */
    }
...
=============================================*/
    static public function sendEmail($name, $subject, $email, $message, $url)
    {
        ...
        $mail->msgHTML('
                    ...
                    ');
        $mail->isMail();
        $mail->setFrom(EMAIL_FROM, "Sistema de Ventas");            
